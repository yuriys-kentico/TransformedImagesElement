...
export abstract class BaseInput<
  TProps extends IInputProps<TType, TValue>,
  TState extends IInputState<TType>,
  TType,
  TValue
> extends PureComponent<TProps, TState> {
  protected input!: HTMLInputElement | null;

  protected isAllowedCharacters = (value: string, characters: string, min = 0, max: number | null = null) =>
    new RegExp(`^[${characters}]{${min},${max || ''}}$`).test(value);

  protected storeValueInState = (value: string) => {
    this.setState({ rawValue: value, isValid: false });
    return value;
  };
  ...
  abstract renderLabel(): ReactNode;
